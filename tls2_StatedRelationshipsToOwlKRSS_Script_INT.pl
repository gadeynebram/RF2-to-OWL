...
#
#   Copyright (c) 2017 International Health Terminology Standards Development Organisation
...
# ***  EXAMPLE COMMAND FOR RUNNING THE SCRIPT: >perl tls2_StatedRelationshipsToOwlKRSS_Script_INT.pl OWLF .
#
#
...
# **************************************************************
# These values are valid for: release format 2 (RF2).
# **************************************************************
# -------------------------------------------------------------------------------------------
...
if ( $dlformat eq "OWL" ) {    # OWL RDF/XML format output
	...
	say OUTF "        <owl:versionIRI rdf:resource=\"http://snomed.info/sct/900000000000207008/version/$release\"/>";
	say OUTF "        <owl:versionInfo>International Release, Core Module, Release Date: $release</owl:versionInfo>";
    ...
    print OUTF "Copyright $year The International Health Terminology Standards Development Organisation (IHTSDO). ";
    ...
    say   OUTF "Details of the SNOMED CT Affiliate Licence may be found at http://ihtsdo.org/snomed-ct/get-snomed-ct .";
    ...
    say OUTF "<http://snomed.info/sct/900000000000207008/version/$release>";
	say OUTF "Annotation(rdfs:label \"SNOMED Clinical Terms, International Release, Stated Relationships in OWL Functional Syntax\")";
	say OUTF "Annotation(owl:versionInfo \"International Release, Core Module, Release Date: $release\")";
	...
	say OUTF "Input descriptions file was         ", $descriptionsFileName;
	say OUTF "Input language refset file was      ", $languageRefsetFileName;
    say OUTF "Copyright $year The International Health Terminology Standards Development Organisation (IHTSDO). All Rights Reserved. SNOMED CT was originally created by The College of American Pathologists. \\\"SNOMED\\\" and \\\"SNOMED CT\\\" are registered trademarks of the IHTSDO.  SNOMED CT has been created by combining SNOMED RT and a computer based nomenclature and classification known as Clinical Terms Version 3, formerly known as Read Codes Version 3, which was created on behalf of the UK Department of Health.";
